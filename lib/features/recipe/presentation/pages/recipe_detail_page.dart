...
class RecipeDetailPage extends StatefulWidget {
  ...
  late final RecipeRemoteDataSourceImpl recipeRemoteDataSource;

  RecipeDetailPage({super.key, required this.id}) {
    recipeRemoteDataSource = RecipeRemoteDataSourceImpl(client: client);
  }
...
class _RecipeDetailPageState extends State<RecipeDetailPage> {
  ...
  // bool _isFavorite(List<FavoriteRecipeModel> favorites) {
  //   return favorites.any((fav) => fav.id == widget.id);
  // }
          ...
          child: BlocBuilder<FavoritesBloc, FavoritesState>(
            builder: (context, state) {
              ...
              return FutureBuilder<RecipeModel>(
                future: widget.recipeRemoteDataSource
                    .getRecipeById(widget.id)
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    // final isFavorite = _isFavorite(favorites);
                    return Stack(
                      children: [
